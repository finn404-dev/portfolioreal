        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              ...
              <q>Just AI Developer</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Sao Lyhour" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="Game store online — code meets automation.
Telegram bot — AI-driven control, instant response."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I am Sao Lyhour — a developer driven by curiosity and powered by an AI mindset.
I build, break, and rebuild ideas through code, turning concepts into real systems.
From backend logic to modern web apps, I enjoy creating things that actually work and solve problems.
Coding isn’t just what I do — it’s how I think, how I learn, and how I grow.
Every line of code is a step toward something smarter, faster, and more meaningful."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      60%<span className="text-violet-500">/100%</span>
                    </h1>
                    <p>AI</p>
                  </div>
                </div>
